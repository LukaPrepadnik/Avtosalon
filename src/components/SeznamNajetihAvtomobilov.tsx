...
interface SeznamNajetihAvtomobilovProps {
    poljeNajetih: IAvto[];
    onDelete: (id: number) => void;
    onVrni: (avto: IAvto) => void;
}

const SeznamNajetihAvtomobilov = (props: SeznamNajetihAvtomobilovProps) => {
    ...
    const handleFilter = props.poljeNajetih.filter(
        (avto) =>
                        ...
                        <div className="col-md-4" key={avto.id}>
                            <div className="card mb-3">
                                ...
                                <div className="card-body">
                                    ...
                                    <Link to={`/rent/${avto.id}`} className="btn btn-warning mr-2">Več</Link>
                                    <button className="btn btn-info" onClick={() => handleVrni(avto)}>Vrni</button>
...
export default SeznamNajetihAvtomobilov;
